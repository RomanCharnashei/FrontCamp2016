...
/***/ function(module, exports, __webpack_require__) {
	...
	var NewsViewer = __webpack_require__(300);
	var NewsService = __webpack_require__(301);
	
	new NewsViewer(new NewsService('2ed7c580e4884a50a6e7d0256ef9e8ce'), document.querySelector('.container')).view();
...
/***/ function(module, exports) {
	...
	module.exports = function () {
	    function NewsViewer(newsSvc, container) {
	    ...
	    _createClass(NewsViewer, [{
	        ...
	        value: function _view() {
	            ...
	            try {
	                for (var _iterator = this._news[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                    var item = _step.value;
	
	                    var innerHTML = '<div class="news-item">' + ('<h2 class="news-item__title">' + item.title + '</h2>') + ('<p class="news-item__content"><img class="news-item__img" src="' + item.urlToImage + '"/>' + item.description + '</p>') + '<div class="news-item__bottom">' + ('<span class="news-item__date">' + new Date(item.publishedAt).toLocaleString() + '</span>') + ('<a class="news-item__src" href="' + item.url + '">' + item.author + '</a>') + '</div>' + '</div>';
	        ...
	        key: 'view',
	        value: function view() {
	            this._newsSvc.getNews().then(this._init.bind(this)).then(this._view.bind(this)).catch(function (error) {
	...
	module.exports = function () {
	    ...
	    _createClass(NewsService, [{
	        ...
	        value: function getNews() {
	            var src = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'techcrunch';
	
	            return fetch('https://newsapi.org/v1/articles?source=' + src + '&apiKey=' + this._apiKey).then(function (res) {
